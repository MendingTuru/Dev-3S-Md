let handler = async (m, { conn, text }) => {
    ...
    conn.reply('Hai @${who.split`@`[0]}. Kamu Telah Di Demote, Karena Kamu Telah Melanggar Rules Yaitu ${text}, Silahkan Dibaca Lagi Rulesnya', '© 3S~Bot', {'button[0]': 'Rules', 'row[0]': '.rules' }, m) 
